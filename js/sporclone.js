...
function start()
{
    if (!playing)
    {
        ...
        // q.
        document.getElementById("time").style.color = "#16BA11";
...
function tick()
{
    ...
    {
        document.getElementById('time').style.color = "#FFF829";
    }
...
function end()
{
    ...
    // x.
    document.getElementById("time").style.color = "#EB0C0C";
    ...
    for (var i=0; i<is_guessed.length; i++)
    {
        ...
        {
         document.getElementById(id).style.backgroundColor = "#16BA11";
        }
        else
        {
         document.getElementById(id).style.backgroundColor = "#EB0C0C";
        }
